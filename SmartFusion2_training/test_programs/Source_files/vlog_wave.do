...
add wave -noupdate -radix hexadecimal -childformat {{{/testbench/Fabric_Top_0/LED_ctrl_0/LED[1]} -radix hexadecimal} {{/testbench/Fabric_Top_0/LED_ctrl_0/LED[0]} -radix hexadecimal}} -subitemconfig {{/testbench/Fabric_Top_0/LED_ctrl_0/LED[1]} {-radix hexadecimal} {/testbench/Fabric_Top_0/LED_ctrl_0/LED[0]} {-radix hexadecimal}} /testbench/Fabric_Top_0/LED_ctrl_0/LED
