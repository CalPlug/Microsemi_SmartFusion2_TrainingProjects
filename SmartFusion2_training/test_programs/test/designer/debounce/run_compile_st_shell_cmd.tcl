...
save
set has_violations {C:\Users\Hiperwall\Desktop\test\test\designer\debounce\debounce_pre_layout_has_violations}
set fp [open $has_violations w]
puts $fp [has_violations -short]
close $fp
report -type combinational_loops -format xml {C:\Users\Hiperwall\Desktop\test\test\designer\debounce\debounce_combinational_loops.xml}
if { [catch "file delete -force -- {C:\Users\Hiperwall\Desktop\test\test\designer\debounce\pinslacks.txt}"] } {
   ;
}
report -type slack {C:\Users\Hiperwall\Desktop\test\test\designer\debounce\pinslacks.txt}
