...
save
set has_violations {C:\Users\Hiperwall\Desktop\microsemilab\UCI_Demo2\designer\M2S_MSS\M2S_MSS_pre_layout_has_violations}
set fp [open $has_violations w]
puts $fp [has_violations -short]
close $fp
report -type combinational_loops -format xml {C:\Users\Hiperwall\Desktop\microsemilab\UCI_Demo2\designer\M2S_MSS\M2S_MSS_combinational_loops.xml}
if { [catch "file delete -force -- {C:\Users\Hiperwall\Desktop\microsemilab\UCI_Demo2\designer\M2S_MSS\pinslacks.txt}"] } {
   ;
}
report -type slack {C:\Users\Hiperwall\Desktop\microsemilab\UCI_Demo2\designer\M2S_MSS\pinslacks.txt}
