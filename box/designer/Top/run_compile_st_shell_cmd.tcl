...
save
set has_violations {C:\Users\Hiperwall\Desktop\microsemilab\box\designer\Top\Top_pre_layout_has_violations}
set fp [open $has_violations w]
puts $fp [has_violations -short]
close $fp
report -type combinational_loops -format xml {C:\Users\Hiperwall\Desktop\microsemilab\box\designer\Top\Top_combinational_loops.xml}
if { [catch "file delete -force -- {C:\Users\Hiperwall\Desktop\microsemilab\box\designer\Top\pinslacks.txt}"] } {
   ;
}
report -type slack {C:\Users\Hiperwall\Desktop\microsemilab\box\designer\Top\pinslacks.txt}
