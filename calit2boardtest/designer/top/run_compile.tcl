...
set_defvar -name {FHB_AUTO_INSTANTIATION} -value {1}
...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\Hiperwall\Desktop\microsemilab\calit2boardtest\synthesis\top.vm"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\Hiperwall\Desktop\microsemilab\calit2boardtest\constraint\top_fhb_auto_generated.ndc"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\Hiperwall\Desktop\microsemilab\calit2boardtest\constraint\top_fhb_auto_generated.ndc"}
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\Hiperwall\Desktop\microsemilab\calit2boardtest\designer\top} \
    -design top \
    -fam SmartFusion2 \
    -die PA4M1000_N \
    -pkg tq144 \
    -pdc_file {C:\Users\Hiperwall\Desktop\microsemilab\calit2boardtest\constraint\top_fhb_auto_generated.ndc} \
    -pdc_file {C:\Users\Hiperwall\Desktop\microsemilab\calit2boardtest\constraint\top_fhb_auto_generated.ndc} \
    -merge_pdc 0
